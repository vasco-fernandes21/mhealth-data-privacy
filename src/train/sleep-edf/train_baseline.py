#!/usr/bin/env python3
"""
Train baseline LSTM model for Sleep-EDF dataset
"""
...
def main():
    ...
    models_output_dir = str(base_dir / "models/sleep-edf/baseline")
    ...
    save_model(model, history, results, models_output_dir, "sleep-edf")
